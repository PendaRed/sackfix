...
/**
  ...
  */
case class DeskOrderHandlingInstField(override val value: String) extends SfFieldString(1035, value) {
  override def toString = appendStringBuilder().toString
  override def appendStringBuilder(b:StringBuilder = new StringBuilder()) = b.append("(1035)DeskOrderHandlingInst=(").append(value).append(")").append(DeskOrderHandlingInstField.fixDescriptionByValue.getOrElse(value,""))
}

object DeskOrderHandlingInstField {
  val TagId = 1035 
  val AddOnOrder="ADD"
  val AllOrNone="AON"
  val CashNotHeld="CNH"
  ...
  def decode(a: Option[Any]) : Option[DeskOrderHandlingInstField] = a match {
    case Some(v) => decode(v)
    case _ =>  scala.Option.empty[DeskOrderHandlingInstField]
  }

  def decode(a: Any) : Option[DeskOrderHandlingInstField] = a match {
    case v: String => Some(DeskOrderHandlingInstField(v))
    case v: DeskOrderHandlingInstField => Some(v)
    case _ => scala.Option.empty[DeskOrderHandlingInstField]
  } 
}
